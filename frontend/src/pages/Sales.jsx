                ...
                <div className="lg:col-span-2">
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                onClick={addToCart}
                                className="w-full bg-gfg-green text-white py-2 rounded-lg hover:bg-blue-700 transition flex items-center justify-center"
                            >
                            ...
                            {cart.length > 0 && (
                                <div className="mt-6">
                                    <h3 className="font-semibold dark:text-white mb-3">Cart Items</h3>
                                    ...
                                    <div className="mt-4 pt-4 border-t dark:border-gray-600">
                                        <div className="flex justify-between items-center mb-4">
                                            ...
                                            <span className="text-2xl font-bold text-gfg-green flex items-center">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4 mb-4">
                                            <div>
                                                <label className="block text-sm font-medium dark:text-gray-300 mb-1 flex items-center">
